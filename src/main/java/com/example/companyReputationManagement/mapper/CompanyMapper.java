...
public class CompanyMapper {
    ...
    public Company mapCompanyCreateRequestDTOToCompany(CompanyCreateRequestDTO companyCreateRequestDTO, String url) {
    ...
    public Company mapCompanyToEditedCompany(Company company, EditCompanyRequestDTO editCompanyRequestDTO) {
        ...
        Optional.ofNullable(editCompanyRequestDTO.getNewOtzovikUrl()).ifPresent(company::setOtzovikUrl);
        return company;
    }
}
