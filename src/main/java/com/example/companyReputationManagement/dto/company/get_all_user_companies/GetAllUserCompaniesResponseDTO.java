...
@Getter
@Setter
public class GetAllUserCompaniesResponseDTO implements ResponseDto {
    ...
    public GetAllUserCompaniesResponseDTO(String companyName, String companyCode, String industry, String website, String otzovikUrl) {
